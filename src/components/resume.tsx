...
export function Resume() {
  // Resume details
  const resumeDetails = {
    title: "Himanshu's Resume",
    description: 'Full Stack Developer • AI Specialist',
    fileType: 'PDF',
    lastUpdated: 'July 2024',
    fileSize: '0.5 MB', // Placeholder value
    previewImageSrc: '/resume_himanshu_preview.png', // Replace with your own image
    downloadUrl: '/resume_himanshu.pdf', // Replace with your own resume
  };
